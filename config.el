...
(after "elfeed-autoloads"
  ...
  (setq elfeed-feeds
        '(("http://feeds.feedburner.com/amirmc" tech)
          ...
          ("https://medium.com/feed/@jlouis666" tech)
          ...
          ("https://stripe.com/blog/feed.rss" company)
          ("http://blog.alfredapp.com/feed/" company)
          ("https://github.com/blog.atom" company)
          ...
          ("http://whattheemacsd.com" emacs)
          ("http://folkelab.dk/feed" misc)
          ...
          ("https://firstlook.org/theintercept/feed/" news)
          ("https://www.schneier.com/blog/atom.xml" tech security)
